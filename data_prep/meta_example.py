...
## From: https://github.com/dfnino10/ODC_Sentinel/blob/master/sen2cor_prepareEO3.py
...
def prepare_dataset(path):
    ...
    for granule_id, images in granules.items():
        ...
        documents.append({
            ...
            'crs': cs_code,
            'grids': {'default': safe_get_grids(images_twenty_list[0]), '10m_res': safe_get_grids(images_ten_list[0]),
                      '60m_res': safe_get_grids(images_sixty_list[0])},
